...
- **Dashboards and reports** - power executive and operational reporting (QuickSight, Grafana, or internal) on lifecycle exposure across the fleet, each date backed by a `sourceUrl`.
